		...
		for (int i = 0; i < 500; i++) {
			...
			b.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					String s = e.getActionCommand(); // 버튼 위 글자를 가져다 줌
					...
					JOptionPane.showMessageDialog(f, "최종 결제금액은 " + payment + "원입니다.");
				}
			});

		}

		// 위에 있는거 보여라! = 맨 끝으로 보내라!!
		f.setVisible(true);
